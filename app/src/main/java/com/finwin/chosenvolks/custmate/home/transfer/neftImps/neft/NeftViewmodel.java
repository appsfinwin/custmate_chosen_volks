...
import com.finwin.chosenvolks.custmate.home.transfer.neftImps.pojo.neft_transfer.model.ModelTransferType;
import com.finwin.chosenvolks.custmate.home.transfer.view_beneficiary_list.pojo.BeneficiaryData;
...
public class NeftViewmodel extends AndroidViewModel implements Observable {
    ...
    public void getBeneficiary() {
        ...
        loading.setContentText("Fetching Beneficiary Details..");
